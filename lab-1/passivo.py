...
while True:
  ...
  if not msg: break
  print(f"Recebido de {endereco}: " + str(msg,  encoding='utf-8'))
  # envia mensagem de resposta
  print(f"Enviando o echo para {endereco}...")
  novoSock.send(msg) 

# fecha o socket da conexao
print(f"Encerrando a conexao com {endereco}...")
novoSock.close() 

# fecha o socket principal
print("Encerrando o socket principal...")
sock.close() 